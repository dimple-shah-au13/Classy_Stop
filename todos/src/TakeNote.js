...
const TakeNote = ({state, ...actions}) => {
    ...
    return(
        <div>
        {
          ...
          <select value={state.notes.tag}  onChange={(e)=>actions.handleChangeNote(e.target.value,"tag")}>
            <option value="Daily">Daily</option>
            <option value="Coding">Coding</option>
            <option value="Attainu">Attainu</option>
        ...
        <Tooltip title="Set the status">
          ...
          Set status:
          <select value={state.notes.status}  onChange={(e)=>actions.handleChangeNote(e.target.value,"status")}>
        ...
        <input type="date"  value={state.notes.dueDate} onChange={(e)=>actions.handleChangeNote(e.target.value,"dueDate")}/>
        </Tooltip>
